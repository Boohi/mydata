---
description: Run a strict agentic TDD loop (red -> green -> refactor -> verify)
---
...
6. Report changed test files plus exact commands and results.

> Backed by the `tdd-ops` skill and `rules/tdd.md`. Mirrors the Codex
> `/prompts:tdd-loop`.
